...
const BlogDetailsPage = () => {
  const shareUrl = `https://youtobe.com`
  return (
    <>
      <Breadcrumb
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div>
                  ...
                  <h3 className="font-xl mb-10 font-bold leading-tight  sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md  bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                  ...
                  <div className="items-center justify-between sm:flex">
                    ...
                    <div className="mb-5">
                      ...
                      <div className="flex items-center justify-between">
                        <div className='px-2'><FacebookShareButton url={shareUrl}>
                          <FacebookIcon size={32} round />
                        </FacebookShareButton>
                        </div>
                        <div className='px-2'><EmailShareButton url={shareUrl}>
                          <EmailIcon size={32} round />
                        </EmailShareButton>
                        </div>
                        <div className='px-2'> <WhatsappShareButton url={shareUrl}>
                          <WhatsappIcon size={32} round />
                        </WhatsappShareButton></div>
                        <div className='px-2'> <LinkedinShareButton url={shareUrl}>
