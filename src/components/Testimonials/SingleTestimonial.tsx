  ...
  return (
    ...
    data-aos-duration="1000">
      <div className="rounded-sm bg-white p-8 shadow-two duration-300 hover:shadow-one dark:bg-dark dark:shadow-three dark:hover:shadow-gray-dark lg:px-5 xl:px-8">
        ...
        <p className="mb-8 border-b border-body-color border-opacity-10 pb-8 text-base leading-relaxed  dark:border-white dark:border-opacity-10 ">
          “{content}
        </p>
        <div className="flex items-center">
          ...
          <div className="w-full">
            <h3 className="mb-1 text-lg font-semibold  lg:text-base xl:text-lg">
              {name}
            </h3>
